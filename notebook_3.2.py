...
def shallow_2_1_3(x1,x2, activation_fn, phi_0,phi_1,phi_2,phi_3, theta_10, theta_11,\
  ...
  h1 = theta_10  + theta_11 * x1 + theta_12 * x2
  pre_1 = h1

  h2 = theta_20  + theta_21 * x1 + theta_22 *x2
  pre_2 = h2

  h3 = theta_30  + theta_31 * x1 + theta_32*x2
  pre_3 = h3
...
def shallow_2_2_3(x1,x2, activation_fn, phi_10,phi_11,phi_12,phi_13, phi_20,phi_21,phi_22,phi_23, theta_10, theta_11,\
  ...
  # TODO -- write this function -- replace the dummy code below     #poprawnic to
  ...
  # Compute the outputs
  y1 = w_act_11 + w_act_12 + w_act_13 + phi_10
  y2 = w_act_21 + w_act_22 + w_act_23 + phi_20
